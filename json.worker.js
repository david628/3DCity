...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return ErrorCode; });
/* unused harmony export ClientCapabilities */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vscode_languageserver_textdocument_lib_esm_main_js__ = __webpack_require__(54);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return __WEBPACK_IMPORTED_MODULE_1__vscode_languageserver_textdocument_lib_esm_main_js__["a"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "f", function() { return __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["e"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "g", function() { return __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["f"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "h", function() { return __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["g"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "o", function() { return __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["m"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__impl_scanner_js__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_objects_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__ = __webpack_require__(0);
    ...
    ValidationResult.prototype.mergeEnumValues = function (validationResult) {
        if (!this.enumValueMatch && !validationResult.enumValueMatch && this.enumValues && validationResult.enumValues) {
            ...
            for (var _i = 0, _a = this.problems; _i < _a.length; _i++) {
                var error = _a[_i];
                if (error.code === __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].EnumValueMismatch) {
    ...
    JSONDocument.prototype.validate = function (textDocument, schema) {
        if (this.root && schema) {
            ...
            return validationResult.problems.map(function (p) {
                var range = __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["k" /* Range */].create(textDocument.positionAt(p.location.offset), textDocument.positionAt(p.location.offset + p.location.length));
                return __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["c" /* Diagnostic */].create(range, p.message, p.severity, p.code);
            });
        }
        return null;
    };
        ...
        if (Array.isArray(schema.type)) {
            if (!schema.type.some(matchesType)) {
                validationResult.problems.push({
                    ...
                    severity: __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["d" /* DiagnosticSeverity */].Warning,
        ...
        if (Array.isArray(schema.enum)) {
            ...
            if (!enumValueMatch) {
                validationResult.problems.push({
                    location: { offset: node.offset, length: node.length },
                    severity: __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["d" /* DiagnosticSeverity */].Warning,
                    code: __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].EnumValueMismatch,
...
function parse(textDocument, config) {
            ...
            switch (token_1) {
                ...
                case 13 /* BlockCommentTrivia */:
                    if (Array.isArray(commentRanges)) {
                        commentRanges.push(__WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["k" /* Range */].create(textDocument.positionAt(scanner.getTokenOffset()), textDocument.positionAt(scanner.getTokenOffset() + scanner.getTokenLength())));
                    }
                    break;
                case 15 /* Trivia */:
    ...
    function _errorAtRange(message, code, startOffset, endOffset, severity) {
        if (severity === void 0) { severity = __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["d" /* DiagnosticSeverity */].Error; }
        if (problems.length === 0 || startOffset !== lastProblemOffset) {
            var range = __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["k" /* Range */].create(textDocument.positionAt(startOffset), textDocument.positionAt(endOffset));
            problems.push(__WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["c" /* Diagnostic */].create(range, message, severity, code, textDocument.languageId));
    ...
    function _checkScanError() {
        switch (scanner.getTokenError()) {
            case 4 /* InvalidUnicode */:
                _error(localize('InvalidUnicode', 'Invalid unicode sequence in string.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].InvalidUnicode);
                return true;
            case 5 /* InvalidEscapeCharacter */:
                _error(localize('InvalidEscapeCharacter', 'Invalid escape character in string.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].InvalidEscapeCharacter);
                return true;
            case 3 /* UnexpectedEndOfNumber */:
                _error(localize('UnexpectedEndOfNumber', 'Unexpected end of number.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].UnexpectedEndOfNumber);
                return true;
            case 1 /* UnexpectedEndOfComment */:
                _error(localize('UnexpectedEndOfComment', 'Unexpected end of comment.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].UnexpectedEndOfComment);
                return true;
            case 2 /* UnexpectedEndOfString */:
                _error(localize('UnexpectedEndOfString', 'Unexpected end of string.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].UnexpectedEndOfString);
                return true;
            case 6 /* InvalidCharacter */:
                _error(localize('InvalidCharacter', 'Invalid characters in string. Control characters must be escaped.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].InvalidCharacter);
                return true;
        }
        return false;
    }
    ...
    function _parseArray(parent) {
        ...
        while (scanner.getToken() !== 4 /* CloseBracketToken */ && scanner.getToken() !== 17 /* EOF */) {
            if (scanner.getToken() === 5 /* CommaToken */) {
                if (!needsComma) {
                    _error(localize('ValueExpected', 'Value expected'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].ValueExpected);
                }
                var commaOffset = scanner.getTokenOffset();
                _scanNext(); // consume comma
                if (scanner.getToken() === 4 /* CloseBracketToken */) {
                    if (needsComma) {
                        _errorAtRange(localize('TrailingComma', 'Trailing comma'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].TrailingComma, commaOffset, commaOffset + 1);
                    }
                    continue;
                }
            }
            else if (needsComma) {
                _error(localize('ExpectedComma', 'Expected comma'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].CommaExpected);
            }
            var item = _parseValue(node, count++);
            if (!item) {
                _error(localize('PropertyExpected', 'Value expected'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].ValueExpected, null, [], [4 /* CloseBracketToken */, 5 /* CommaToken */]);
            }
            else {
        ...
        if (scanner.getToken() !== 4 /* CloseBracketToken */) {
            return _error(localize('ExpectedCloseBracket', 'Expected comma or closing bracket'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].CommaOrCloseBacketExpected, node);
        }
    ...
    function _parseProperty(parent, keysSeen) {
        ...
        if (!key) {
            if (scanner.getToken() === 16 /* Unknown */) {
                ...
                _error(localize('DoubleQuotesExpected', 'Property keys must be doublequoted'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].Undefined);
        ...
        if (seen) {
            _errorAtRange(localize('DuplicateKeyWarning', "Duplicate object key"), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].DuplicateKey, node.keyNode.offset, node.keyNode.offset + node.keyNode.length, __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["d" /* DiagnosticSeverity */].Warning);
            if (typeof seen === 'object') {
                _errorAtRange(localize('DuplicateKeyWarning', "Duplicate object key"), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].DuplicateKey, seen.keyNode.offset, seen.keyNode.offset + seen.keyNode.length, __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["d" /* DiagnosticSeverity */].Warning);
            }
        ...
        if (scanner.getToken() === 6 /* ColonToken */) {
            ...
            _error(localize('ColonExpected', 'Colon expected'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].ColonExpected);
        ...
        if (!value) {
            return _error(localize('ValueExpected', 'Value expected'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].ValueExpected, node, [], [2 /* CloseBraceToken */, 5 /* CommaToken */]);
        }
    ...
    function _parseObject(parent) {
        ...
        while (scanner.getToken() !== 2 /* CloseBraceToken */ && scanner.getToken() !== 17 /* EOF */) {
            if (scanner.getToken() === 5 /* CommaToken */) {
                if (!needsComma) {
                    _error(localize('PropertyExpected', 'Property expected'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].PropertyExpected);
                }
                var commaOffset = scanner.getTokenOffset();
                _scanNext(); // consume comma
            ...
            if (!property) {
                _error(localize('PropertyExpected', 'Property expected'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].PropertyExpected, null, [], [2 /* CloseBraceToken */, 5 /* CommaToken */]);
            }
            else {
        ...
        if (scanner.getToken() !== 2 /* CloseBraceToken */) {
            return _error(localize('ExpectedCloseBrace', 'Expected comma or closing brace'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].CommaOrCloseBraceExpected, node);
        }
        return _finalize(node, true);
    }
        ...
        if (scanner.getTokenError() === 0 /* None */) {
            ...
            try {
                ...
                if (!Object(__WEBPACK_IMPORTED_MODULE_1__utils_objects_js__["d" /* isNumber */])(numberValue)) {
                    return _error(localize('InvalidNumberFormat', 'Invalid number format.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].Undefined, node);
                }
    ...
    if (token !== 17 /* EOF */) {
        ...
        if (!_root) {
            _error(localize('Invalid symbol', 'Expected a JSON object, array or literal.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].Undefined);
        }
        else if (scanner.getToken() !== 17 /* EOF */) {
            _error(localize('End of file expected', 'End of file expected.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["e" /* ErrorCode */].Undefined);
        }
    }
...
if (typeof navigator === 'object' && !isElectronRenderer) {
    ...
    var rawNlsConfig = Object({"NODE_ENV":"production","PUBLIC_URL":"/3DCity"})['VSCODE_NLS_CONFIG'];
    if (rawNlsConfig) {
        try {
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(8), __webpack_require__(5)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hash_js__ = __webpack_require__(30);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
    ...
    LcsDiff._getElements = function (sequence) {
        ...
        if (LcsDiff._isStringArray(elements)) {
            ...
            for (var i = 0, len = elements.length; i < len; i++) {
                hashes[i] = Object(__WEBPACK_IMPORTED_MODULE_1__hash_js__["a" /* stringHash */])(elements[i], 0);
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__errors_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functional_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lifecycle_js__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scanner_js__ = __webpack_require__(10);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jsonc_parser_main_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vscode_uri_index_js__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_strings_js__ = __webpack_require__(12);
...
var JSONSchemaService = /** @class */ (function () {
    ...
    JSONSchemaService.prototype.loadSchema = function (url) {
        ...
        return this.requestService(url).then(function (content) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_2__utils_strings_js__["b" /* endsWith */](errorMessage, '.')) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__errors_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lifecycle_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__platform_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__types_js__ = __webpack_require__(14);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_diff_diff_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_common_iterator_js__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__base_common_platform_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_common_uri_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_position_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_range_js__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__base_common_types_js__ = __webpack_require__(14);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
    ...
    EditorSimpleWorker.prototype.computeDiff = function (originalUrl, modifiedUrl, ignoreTrimWhitespace, maxComputationTime) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                diffComputer = new __WEBPACK_IMPORTED_MODULE_7__diff_diffComputer_js__["a" /* DiffComputer */](originalLines, modifiedLines, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                for (_i = 0, edits_1 = edits; _i < edits_1.length; _i++) {
                    ...
                    changes = Object(__WEBPACK_IMPORTED_MODULE_1__base_common_diff_diff_js__["b" /* stringDiff */])(original, text, false);
                    editOffset = model.offsetAt(__WEBPACK_IMPORTED_MODULE_6__core_range_js__["a" /* Range */].lift(range).getStartPosition());
    ...
    EditorSimpleWorker.prototype.computeLinks = function (modelUrl) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Object(__WEBPACK_IMPORTED_MODULE_10__modes_linkComputer_js__["a" /* computeLinks */])(model)];
            });
        });
    };
    ...
    EditorSimpleWorker.prototype.navigateValueSet = function (modelUrl, range, up, wordDef, wordDefFlags) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                result = __WEBPACK_IMPORTED_MODULE_11__modes_supports_inplaceReplaceSupport_js__["a" /* BasicInplaceReplace */].INSTANCE.navigateValueSet(range, selectionText, wordRange, word, up);
                return [2 /*return*/, result];
            });
        });
    };
...
/* unused harmony export fromSet */
/* unused harmony export firstIndex */
/* unused harmony export first */
/* unused harmony export firstOrDefault */
...
/* harmony export (immutable) */ __webpack_exports__["a"] = stringHash;
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_diff_diff_js__ = __webpack_require__(15);
...
/* unused harmony export getNextCodePoint */
/* unused harmony export nextCharLength */
/* unused harmony export prevCharLength */
...
/* unused harmony export isEmojiImprecise */
...
/* unused harmony export getGraphemeBreakType */
/* unused harmony export breakBetweenGraphemeBreakType */
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_uint_js__ = __webpack_require__(18);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var PrefixSumComputer = /** @class */ (function () {
    ...
    PrefixSumComputer.prototype.insertValues = function (insertIndex, insertValues) {
        insertIndex = Object(__WEBPACK_IMPORTED_MODULE_0__base_common_uint_js__["a" /* toUint32 */])(insertIndex);
    ...
    PrefixSumComputer.prototype.changeValue = function (index, value) {
        index = Object(__WEBPACK_IMPORTED_MODULE_0__base_common_uint_js__["a" /* toUint32 */])(index);
        value = Object(__WEBPACK_IMPORTED_MODULE_0__base_common_uint_js__["a" /* toUint32 */])(value);
    ...
    PrefixSumComputer.prototype.removeValues = function (startIndex, cnt) {
        startIndex = Object(__WEBPACK_IMPORTED_MODULE_0__base_common_uint_js__["a" /* toUint32 */])(startIndex);
        cnt = Object(__WEBPACK_IMPORTED_MODULE_0__base_common_uint_js__["a" /* toUint32 */])(cnt);
        var oldValues = this.values;
        var oldPrefixSum = this.prefixSum;
...
var CharacterClassifier = /** @class */ (function () {
    function CharacterClassifier(_defaultValue) {
        var defaultValue = Object(__WEBPACK_IMPORTED_MODULE_0__base_common_uint_js__["b" /* toUint8 */])(_defaultValue);
    ...
    CharacterClassifier.prototype.set = function (charCode, _value) {
        var value = Object(__WEBPACK_IMPORTED_MODULE_0__base_common_uint_js__["b" /* toUint8 */])(_value);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(41).setImmediate, __webpack_require__(5)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__iterator_js__ = __webpack_require__(16);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__position_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__range_js__ = __webpack_require__(9);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
"use strict";
/* unused harmony export AccessibilitySupport */
...
/* unused harmony export DocumentHighlightKind */
/* unused harmony export EditorAutoIndentStrategy */
/* unused harmony export EditorOption */
...
var JSONWorker = /** @class */ (function () {
    function JSONWorker(ctx, createData) {
        ...
        this._languageService = __WEBPACK_IMPORTED_MODULE_0__deps_vscode_json_languageservice_jsonLanguageService_js__["b" /* getLanguageService */]({
    ...
    JSONWorker.prototype._getTextDocument = function (uri) {
        ...
        for (var _i = 0, models_1 = models; _i < models_1.length; _i++) {
            ...
            if (model.uri.toString() === uri) {
                return __WEBPACK_IMPORTED_MODULE_0__deps_vscode_json_languageservice_jsonLanguageService_js__["a" /* TextDocument */].create(uri, this._languageId, model.version, model.getValue());
            }
        }
        return null;
    };
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = getLanguageService;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_jsonCompletion_js__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_jsonHover_js__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_jsonValidation_js__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_jsonDocumentSymbols_js__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__parser_jsonParser_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_configuration_js__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_jsonSchemaService_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_jsonFolding_js__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_jsonSelectionRanges_js__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__jsonc_parser_main_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__jsonLanguageTypes_js__ = __webpack_require__(0);
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_10__jsonLanguageTypes_js__["n"]; });
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function getLanguageService(params) {
    ...
    var jsonSchemaService = new __WEBPACK_IMPORTED_MODULE_6__services_jsonSchemaService_js__["a" /* JSONSchemaService */](params.schemaRequestService, params.workspaceContext, promise);
    jsonSchemaService.setSchemaContributions(__WEBPACK_IMPORTED_MODULE_5__services_configuration_js__["a" /* schemaContributions */]);
    var jsonCompletion = new __WEBPACK_IMPORTED_MODULE_0__services_jsonCompletion_js__["a" /* JSONCompletion */](jsonSchemaService, params.contributions, promise, params.clientCapabilities);
    var jsonHover = new __WEBPACK_IMPORTED_MODULE_1__services_jsonHover_js__["a" /* JSONHover */](jsonSchemaService, params.contributions, promise);
    var jsonDocumentSymbols = new __WEBPACK_IMPORTED_MODULE_3__services_jsonDocumentSymbols_js__["a" /* JSONDocumentSymbols */](jsonSchemaService);
    var jsonValidation = new __WEBPACK_IMPORTED_MODULE_2__services_jsonValidation_js__["a" /* JSONValidation */](jsonSchemaService, promise);
    return {
        ...
        parseJSONDocument: function (document) { return Object(__WEBPACK_IMPORTED_MODULE_4__parser_jsonParser_js__["f" /* parse */])(document, { collectComments: true }); },
        newJSONDocument: function (root, diagnostics) { return Object(__WEBPACK_IMPORTED_MODULE_4__parser_jsonParser_js__["e" /* newJSONDocument */])(root, diagnostics); },
        ...
        getFoldingRanges: __WEBPACK_IMPORTED_MODULE_7__services_jsonFolding_js__["a" /* getFoldingRanges */],
        getSelectionRanges: __WEBPACK_IMPORTED_MODULE_8__services_jsonSelectionRanges_js__["a" /* getSelectionRanges */],
        format: function (d, r, o) {
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_9__jsonc_parser_main_js__["c" /* format */])(d.getText(), range, options).map(function (e) {
                return __WEBPACK_IMPORTED_MODULE_10__jsonLanguageTypes_js__["o" /* TextEdit */].replace(__WEBPACK_IMPORTED_MODULE_10__jsonLanguageTypes_js__["k" /* Range */].create(d.positionAt(e.offset), d.positionAt(e.offset + e.length)), e.content);
            });
        }
    };
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_json_js__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_strings_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_objects_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__ = __webpack_require__(0);
...
var JSONCompletion = /** @class */ (function () {
    ...
    JSONCompletion.prototype.doComplete = function (document, position, doc) {
        ...
        if (node && (node.type === 'string' || node.type === 'number' || node.type === 'boolean' || node.type === 'null')) {
            overwriteRange = __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["k" /* Range */].create(document.positionAt(node.offset), document.positionAt(node.offset + node.length));
        }
        else {
            ...
            overwriteRange = __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["k" /* Range */].create(document.positionAt(overwriteStart), position);
        }
        ...
        var collector = {
            add: function (suggestion) {
                ...
                if (!existing) {
                    ...
                    if (overwriteRange) {
                        suggestion.textEdit = __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["o" /* TextEdit */].replace(overwriteRange, suggestion.insertText);
                    }
                    if (supportsCommitCharacters) {
                        suggestion.commitCharacters = suggestion.kind === __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["b" /* CompletionItemKind */].Property ? propertyCommitCharacters : valueCommitCharacters;
                    }
            ...
            if (node && node.type === 'object') {
                ...
                properties.forEach(function (p) {
                    if (!currentProperty || currentProperty !== p) {
                        proposed[p.keyNode.value] = __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["a" /* CompletionItem */].create('__');
                    }
                });
                ...
                if ((!schema && currentWord.length > 0 && text.charAt(offset - currentWord.length - 1) !== '"')) {
                    collector.add({
                        kind: __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["b" /* CompletionItemKind */].Property,
                        label: _this.getLabelForValue(currentWord),
                        insertText: _this.getInsertTextForProperty(currentWord, null, false, separatorAfter_1),
                        insertTextFormat: __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["g" /* InsertTextFormat */].Snippet, documentation: '',
                    });
                    ...
                    Object.keys(schemaProperties_1).forEach(function (key) {
                        ...
                        if (typeof propertySchema === 'object' && !propertySchema.deprecationMessage && !propertySchema.doNotSuggest) {
                            var proposal = {
                                ...
                                insertTextFormat: __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["g" /* InsertTextFormat */].Snippet,
    ...
    JSONCompletion.prototype.addDollarSchemaCompletions = function (separatorAfter, collector) {
        ...
        schemaIds.forEach(function (schemaId) { return collector.add({
            kind: __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["b" /* CompletionItemKind */].Module,
    ...
    JSONCompletion.prototype.getSuggestionKind = function (type) {
        ...
        if (!type) {
            return __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["b" /* CompletionItemKind */].Value;
        }
        switch (type) {
            case 'string': return __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["b" /* CompletionItemKind */].Value;
            case 'object': return __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["b" /* CompletionItemKind */].Module;
            case 'property': return __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["b" /* CompletionItemKind */].Property;
            default: return __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["b" /* CompletionItemKind */].Value;
        }
    };
    ...
    JSONCompletion.prototype.fromMarkup = function (markupString) {
        if (markupString && this.doesSupportMarkdown()) {
            return {
                kind: __WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["i" /* MarkupKind */].Markdown,
                value: markupString
            };
        }
        return undefined;
    ...
    JSONCompletion.prototype.doesSupportMarkdown = function () {
        if (!Object(__WEBPACK_IMPORTED_MODULE_4__utils_objects_js__["c" /* isDefined */])(this.supportsMarkdown)) {
            ...
            this.supportsMarkdown = completion && completion.completionItem && Array.isArray(completion.completionItem.documentationFormat) && completion.completionItem.documentationFormat.indexOf(__WEBPACK_IMPORTED_MODULE_5__jsonLanguageTypes_js__["i" /* MarkupKind */].Markdown) !== -1;
        }
        return this.supportsMarkdown;
    };
    JSONCompletion.prototype.doesSupportsCommitCharacters = function () {
        if (!Object(__WEBPACK_IMPORTED_MODULE_4__utils_objects_js__["c" /* isDefined */])(this.supportsCommitCharacters)) {
            var completion = this.clientCapabilities.textDocument && this.clientCapabilities.textDocument.completion;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__ = __webpack_require__(0);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var JSONHover = /** @class */ (function () {
    ...
    JSONHover.prototype.doHover = function (document, position, doc) {
        ...
        var hoverRange = __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["k" /* Range */].create(document.positionAt(hoverRangeNode.offset), document.positionAt(hoverRangeNode.offset + hoverRangeNode.length));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fillers_vscode_nls_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_objects_js__ = __webpack_require__(11);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var JSONValidation = /** @class */ (function () {
    ...
    JSONValidation.prototype.configure = function (raw) {
        if (raw) {
            ...
            this.commentSeverity = raw.allowComments ? void 0 : __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["d" /* DiagnosticSeverity */].Error;
        }
    };
    JSONValidation.prototype.doValidation = function (textDocument, jsonDocument, documentSettings, schema) {
        ...
        var getDiagnostics = function (schema) {
            var trailingCommaSeverity = documentSettings ? toDiagnosticSeverity(documentSettings.trailingCommas) : __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["d" /* DiagnosticSeverity */].Error;
            ...
            if (schema) {
                if (schema.errors.length && jsonDocument.root) {
                    ...
                    if (property && property.keyNode.value === '$schema') {
                        ...
                        var range = __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["k" /* Range */].create(textDocument.positionAt(node.offset), textDocument.positionAt(node.offset + node.length));
                        addProblem(__WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["c" /* Diagnostic */].create(range, schema.errors[0], __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["d" /* DiagnosticSeverity */].Warning, __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["e" /* ErrorCode */].SchemaResolveError));
                    }
                    else {
                        var range = __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["k" /* Range */].create(textDocument.positionAt(astRoot.offset), textDocument.positionAt(astRoot.offset + 1));
                        addProblem(__WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["c" /* Diagnostic */].create(range, schema.errors[0], __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["d" /* DiagnosticSeverity */].Warning, __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["e" /* ErrorCode */].SchemaResolveError));
                    }
                }
                else {
            ...
            for (var _i = 0, _a = jsonDocument.syntaxErrors; _i < _a.length; _i++) {
                var p = _a[_i];
                if (p.code === __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["e" /* ErrorCode */].TrailingComma) {
            ...
            if (typeof commentSeverity === 'number') {
                ...
                jsonDocument.comments.forEach(function (c) {
                    addProblem(__WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["c" /* Diagnostic */].create(c, message_1, commentSeverity, __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["e" /* ErrorCode */].CommentNotPermitted));
                });
            }
            return diagnostics;
        };
...
function schemaAllowsComments(schemaRef) {
    if (schemaRef && typeof schemaRef === 'object') {
        if (Object(__WEBPACK_IMPORTED_MODULE_3__utils_objects_js__["b" /* isBoolean */])(schemaRef.allowComments)) {
        ...
        if (schemaRef.allOf) {
            for (var _i = 0, _a = schemaRef.allOf; _i < _a.length; _i++) {
                ...
                if (Object(__WEBPACK_IMPORTED_MODULE_3__utils_objects_js__["b" /* isBoolean */])(allow)) {
                    return allow;
                }
            }
        }
...
function schemaAllowsTrailingCommas(schemaRef) {
    if (schemaRef && typeof schemaRef === 'object') {
        if (Object(__WEBPACK_IMPORTED_MODULE_3__utils_objects_js__["b" /* isBoolean */])(schemaRef.allowTrailingCommas)) {
            return schemaRef.allowTrailingCommas;
        }
        if (Object(__WEBPACK_IMPORTED_MODULE_3__utils_objects_js__["b" /* isBoolean */])(schemaRef['allowsTrailingCommas'])) { // deprecated
...
function toDiagnosticSeverity(severityLevel) {
    switch (severityLevel) {
        case 'error': return __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["d" /* DiagnosticSeverity */].Error;
        case 'warning': return __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["d" /* DiagnosticSeverity */].Warning;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_strings_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_colors_js__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__ = __webpack_require__(0);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var JSONDocumentSymbols = /** @class */ (function () {
                    ...
                    if (item.type === 'object') {
                        for (var _b = 0, _c = item.properties; _b < _c.length; _b++) {
                            ...
                            if (property.keyNode.value === 'key' && property.valueNode) {
                                var location = __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__["h" /* Location */].create(document.uri, getRange(document, item));
                                result_1.push({ name: __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__["d" /* getNodeValue */](property.valueNode), kind: __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__["m" /* SymbolKind */].Function, location: location });
                                limit--;
                                if (limit <= 0) {
            ...
            if (node.type === 'array') {
                ...
                node.properties.forEach(function (property) {
                    ...
                    if (valueNode) {
                        if (limit > 0) {
                            limit--;
                            var location = __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__["h" /* Location */].create(document.uri, getRange(document, property));
                    ...
                    if (item.type === 'object') {
                        for (var _b = 0, _c = item.properties; _b < _c.length; _b++) {
                            ...
                            if (property.keyNode.value === 'key' && property.valueNode) {
                                ...
                                result_2.push({ name: __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__["d" /* getNodeValue */](property.valueNode), kind: __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__["m" /* SymbolKind */].Function, range: range, selectionRange: selectionRange });
                                limit--;
                                if (limit <= 0) {
                                    if (context && context.onResultLimitExceeded) {
                                        context.onResultLimitExceeded(resourceString);
    ...
    JSONDocumentSymbols.prototype.getSymbolKind = function (nodeType) {
        switch (nodeType) {
            case 'object':
                return __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__["m" /* SymbolKind */].Module;
            case 'string':
                return __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__["m" /* SymbolKind */].String;
            case 'number':
                return __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__["m" /* SymbolKind */].Number;
            case 'array':
                return __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__["m" /* SymbolKind */].Array;
            case 'boolean':
                return __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__["m" /* SymbolKind */].Boolean;
            default: // 'null'
                return __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__["m" /* SymbolKind */].Variable;
        }
    };
    ...
    JSONDocumentSymbols.prototype.getColorPresentations = function (document, doc, color, range) {
        ...
        result.push({ label: label, textEdit: __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__["o" /* TextEdit */].replace(range, JSON.stringify(label)) });
        return result;
    };
...
function getRange(document, node) {
    return __WEBPACK_IMPORTED_MODULE_3__jsonLanguageTypes_js__["k" /* Range */].create(document.positionAt(node.offset), document.positionAt(node.offset + node.length));
}
...
function getFoldingRanges(document, context) {
    ...
    var stack = [];
    var prevStart = -1;
    var scanner = Object(__WEBPACK_IMPORTED_MODULE_0__jsonc_parser_main_js__["a" /* createScanner */])(document.getText(), false);
    var token = scanner.scan();
        ...
        switch (token) {
            ...
            case 13 /* BlockCommentTrivia */: {
                ...
                if (scanner.getTokenError() === 1 /* UnexpectedEndOfComment */ && startLine + 1 < document.lineCount) {
                    scanner.setPosition(document.offsetAt(__WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["j" /* Position */].create(startLine + 1, 0)));
                }
                else {
                    if (startLine < endLine) {
                        addRange({ startLine: startLine, endLine: endLine, kind: __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["f" /* FoldingRangeKind */].Comment });
                        prevStart = startLine;
                    }
                }
                break;
            ...
            case 12 /* LineCommentTrivia */: {
                ...
                if (m) {
                    ...
                    if (m[1]) { // start pattern match
                        var range = { startLine: line, endLine: line, kind: __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["f" /* FoldingRangeKind */].Region };
                        stack.push(range);
                    }
                    else {
                        var i = stack.length - 1;
                        while (i >= 0 && stack[i].kind !== __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["f" /* FoldingRangeKind */].Region) {
                            i--;
                        }
                        if (i >= 0) {
                            var range = stack[i];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jsonLanguageTypes_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__jsonc_parser_main_js__ = __webpack_require__(1);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
...
function getSelectionRanges(document, positions, doc) {
    function getSelectionRange(position) {
        ...
        for (var index = result.length - 1; index >= 0; index--) {
            current = __WEBPACK_IMPORTED_MODULE_0__jsonLanguageTypes_js__["l" /* SelectionRange */].create(result[index], current);
        }
        if (!current) {
            current = __WEBPACK_IMPORTED_MODULE_0__jsonLanguageTypes_js__["l" /* SelectionRange */].create(__WEBPACK_IMPORTED_MODULE_0__jsonLanguageTypes_js__["k" /* Range */].create(position, position));
        }
        return current;
    }
    function newRange(start, end) {
        return __WEBPACK_IMPORTED_MODULE_0__jsonLanguageTypes_js__["k" /* Range */].create(document.positionAt(start), document.positionAt(end));
    }
